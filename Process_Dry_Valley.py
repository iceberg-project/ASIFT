...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  4 15:42:27 2019
...
img_names = [modify_directory_to_local_machine(fn) for fn in 
             (r'/home/mmacferrin/Dropbox/Research/IceBerg-Personal/ASIFT/ASIFT_Images/TMA Airborne/CA179332V0074_CROPPED.tif',
              r'/home/mmacferrin/Dropbox/Research/IceBerg-Personal/ASIFT/ASIFT_Images/WorldView BEST/WV01_20161218_102001005C18BF00_1020010058E7BE00_seg1_2m_ortho.tif')]
...
if STEP == 1:
    ...
    for img_fname in img_names:
        ...
        # Generate sub-tiles from this image. DON'T contrast-enhance
...
#    targets_list = [modify_directory_to_local_machine(path) for path in targets_list]
    ...
    sources_list = [r'/home/mmacferrin/Dropbox/Research/IceBerg-Personal/ASIFT/ASIFT_Scratch/CA17_22ed0c3f13591d3605c37999c3380939/CA17_22ed0c3f13591d3605c37999c3380939_4_0_2166_0_2240.tif']
    targets_list = [r'/home/mmacferrin/Dropbox/Research/IceBerg-Personal/ASIFT/ASIFT_Scratch/WV01_0594d861f9de068e9e7cfeb48b0e4639/WV01_0594d861f9de068e9e7cfeb48b0e4639_4_1629_2371_6000_2000.tif']
